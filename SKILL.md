---
name: xxd-panel-216
description: "Create Panel 216 raster artwork: Tiny Print Island in Vast Negative Space. Use when the user invokes xxd-panel-216 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-216/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-216-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
